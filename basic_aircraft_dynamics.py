...
runway = Entity(model='plane', scale=(140, 140, 140), texture="runway.jpg", position=(0, 1, 0), collider='box')
...
cube = Entity(parent=scene, position = (0,10,0), scale=(0.1,0.1,0.1), collider = 'box')
...
# cube = Entity(model='f35', color=color.white, scale=(0.1, 0.1, 0.1), position=() collider='box')
cube.rotation_y = 90
...
def update():
    ...
    cube.position -= cube.forward * engine_speed * time.dt * 100
